...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="ProhodKAZBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" Bot %CMD_LINE_ARGS%
